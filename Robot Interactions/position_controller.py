...
def main(task):
    ...
    if task == 'initPose':
        ...
        left_arm.gripper_close() # Close the grib to grab the brick

        # Position 2: Left arm moves the brick to the red dot
        left_arm.servo_to_pose([0.75, 0.5, 0.05],left_rpy)
        left_arm.servo_to_pose([0.75, 0.0, 0.05],left_rpy)
        left_arm.servo_to_pose([0.75, 0.0, -0.052],left_rpy)
        left_arm.gripper_open() # Open the grib to release the brick 
        ...
        right_arm.gripper_close() # Close the grib to grab the brick
        ...
        right_arm.gripper_open() # Open the grib to release the brick
        ...
        right_arm.gripper_close() # Right arm closes the grib to grab the brick
        left_arm.gripper_open() # Left arm opens the grib to release the brick
